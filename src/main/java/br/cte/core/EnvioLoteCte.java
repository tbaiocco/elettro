...
public class EnvioLoteCte {
    ...
    public CteLote executar() {
        ...
        if (empresa == null) {
            erros.put("empresa", "N�o foi poss�vel carregar dados da empresa");
        } else {
            ...
            if (webservice == null) {
                erros.put("webservice", "N�o foi poss�vel carregar dados do webservice");
            } else if (!CertDig.getInstance().setProprierts(empresa)) {
                erros.put("certificado digital", "N�o foi poss�vel setar propriedades do certificado digital.");
            } else {
