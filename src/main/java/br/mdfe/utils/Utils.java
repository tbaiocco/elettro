...
public class Utils {
	...
	public String removeAcentuacao(String text) {
		...
		String[] REPLACES = { "a", "e", "i", "o", "u", "c", "A", "E", "I", "O", "U", "C", " ", "", "CA", "C", "C",
				"1_o" };
	...
	public static boolean doValida(String parametro) {
		return parametro != null && !"0".equals(parametro.trim()) && !"0,00".equals(parametro.trim())
				&& !"0,000".equals(parametro.trim()) && !"0.00".equals(parametro.trim())
				&& !"0.000".equals(parametro.trim()) && !"".equals(parametro.trim())
